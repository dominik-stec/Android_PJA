...
class BoyPercentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_boy_percent)
        allLayoutIds
        bundleValues
        setLayoutFields()
    ...
    private val allLayoutIds: Unit
        private get() {
            bmiView = findViewById<View>(R.id.boyBmi) as TextView
            ageView = findViewById<View>(R.id.boyAge) as TextView
...
//import androidx.appcompat.app.AppCompatActivity;
//
//public class BoyPercentActivity extends AppCompatActivity {
//
...
//        bmiView = (TextView) findViewById(R.id.boyBmi);
//        ageView = (TextView) findViewById(R.id.boyAge);
